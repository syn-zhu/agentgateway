...
// MarshalJSON is a custom marshaler for TrafficPolicySpec_AAuth
func (this *TrafficPolicySpec_AAuth) MarshalJSON() ([]byte, error) {
	str, err := ResourceMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for TrafficPolicySpec_AAuth
func (this *TrafficPolicySpec_AAuth) UnmarshalJSON(b []byte) error {
	return ResourceUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}

// MarshalJSON is a custom marshaler for TrafficPolicySpec_AAuth_Challenge
func (this *TrafficPolicySpec_AAuth_Challenge) MarshalJSON() ([]byte, error) {
	str, err := ResourceMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for TrafficPolicySpec_AAuth_Challenge
func (this *TrafficPolicySpec_AAuth_Challenge) UnmarshalJSON(b []byte) error {
	return ResourceUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
...
// MarshalJSON is a custom marshaler for BackendPolicySpec_AAuth
func (this *BackendPolicySpec_AAuth) MarshalJSON() ([]byte, error) {
	str, err := ResourceMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for BackendPolicySpec_AAuth
func (this *BackendPolicySpec_AAuth) UnmarshalJSON(b []byte) error {
	return ResourceUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
