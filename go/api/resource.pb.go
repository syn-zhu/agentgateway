...
// Validation mode for AAuth signature verification
type TrafficPolicySpec_AAuth_Mode int32

const (
	// A valid signature must be present (default)
	TrafficPolicySpec_AAuth_STRICT TrafficPolicySpec_AAuth_Mode = 0
	// If signature exists, validate it. Otherwise allow.
	TrafficPolicySpec_AAuth_OPTIONAL TrafficPolicySpec_AAuth_Mode = 1
	// Requests are never rejected. Useful for logging/claims extraction.
	TrafficPolicySpec_AAuth_PERMISSIVE TrafficPolicySpec_AAuth_Mode = 2
)

// Enum value maps for TrafficPolicySpec_AAuth_Mode.
var (
	TrafficPolicySpec_AAuth_Mode_name = map[int32]string{
		0: "STRICT",
		1: "OPTIONAL",
		2: "PERMISSIVE",
	}
	TrafficPolicySpec_AAuth_Mode_value = map[string]int32{
		"STRICT":     0,
		"OPTIONAL":   1,
		"PERMISSIVE": 2,
	}
...
func (x TrafficPolicySpec_AAuth_Mode) Enum() *TrafficPolicySpec_AAuth_Mode {
	p := new(TrafficPolicySpec_AAuth_Mode)
	*p = x
	return p
}

func (x TrafficPolicySpec_AAuth_Mode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TrafficPolicySpec_AAuth_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_resource_proto_enumTypes[13].Descriptor()
}

func (TrafficPolicySpec_AAuth_Mode) Type() protoreflect.EnumType {
	return &file_resource_proto_enumTypes[13]
}

func (x TrafficPolicySpec_AAuth_Mode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TrafficPolicySpec_AAuth_Mode.Descriptor instead.
func (TrafficPolicySpec_AAuth_Mode) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{43, 8, 0}
}

// Minimum authentication level required
type TrafficPolicySpec_AAuth_RequiredScheme int32

const (
	// Any signature is sufficient (pseudonymous)
	TrafficPolicySpec_AAuth_HWK TrafficPolicySpec_AAuth_RequiredScheme = 0
	// Must have verifiable identity via JWKS
	TrafficPolicySpec_AAuth_JWKS TrafficPolicySpec_AAuth_RequiredScheme = 1
	// Must have authorization token (JWT-bound)
	TrafficPolicySpec_AAuth_JWT_SCHEME TrafficPolicySpec_AAuth_RequiredScheme = 2
)

// Enum value maps for TrafficPolicySpec_AAuth_RequiredScheme.
var (
	TrafficPolicySpec_AAuth_RequiredScheme_name = map[int32]string{
		0: "HWK",
		1: "JWKS",
		2: "JWT_SCHEME",
	}
	TrafficPolicySpec_AAuth_RequiredScheme_value = map[string]int32{
		"HWK":        0,
		"JWKS":       1,
		"JWT_SCHEME": 2,
	}
...
func (x TrafficPolicySpec_AAuth_RequiredScheme) Enum() *TrafficPolicySpec_AAuth_RequiredScheme {
	p := new(TrafficPolicySpec_AAuth_RequiredScheme)
	*p = x
	return p
}

func (x TrafficPolicySpec_AAuth_RequiredScheme) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TrafficPolicySpec_AAuth_RequiredScheme) Descriptor() protoreflect.EnumDescriptor {
	return file_resource_proto_enumTypes[14].Descriptor()
}

func (TrafficPolicySpec_AAuth_RequiredScheme) Type() protoreflect.EnumType {
	return &file_resource_proto_enumTypes[14]
}

func (x TrafficPolicySpec_AAuth_RequiredScheme) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TrafficPolicySpec_AAuth_RequiredScheme.Descriptor instead.
func (TrafficPolicySpec_AAuth_RequiredScheme) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{43, 8, 1}
}
...
func (x *TrafficPolicySpec) GetAauth() *TrafficPolicySpec_AAuth {
	if x != nil {
		if x, ok := x.Kind.(*TrafficPolicySpec_Aauth); ok {
			return x.Aauth
		}
	}
	return nil
...
type TrafficPolicySpec_Aauth struct {
	Aauth *TrafficPolicySpec_AAuth `protobuf:"bytes,22,opt,name=aauth,proto3,oneof"`
}
...
func (*TrafficPolicySpec_Aauth) isTrafficPolicySpec_Kind() {}
...
func (x *BackendPolicySpec) GetAauth() *BackendPolicySpec_AAuth {
	if x != nil {
		if x, ok := x.Kind.(*BackendPolicySpec_Aauth); ok {
			return x.Aauth
		}
	}
	return nil
...
type BackendPolicySpec_Aauth struct {
	Aauth *BackendPolicySpec_AAuth `protobuf:"bytes,14,opt,name=aauth,proto3,oneof"`
}
...
func (*BackendPolicySpec_Aauth) isBackendPolicySpec_Kind() {}
...
// AAuth (Agent Authentication) via RFC 9421 HTTP Message Signatures.
// Verifies that incoming requests are signed by an identified agent using
// Ed25519 key pairs, with identity verified against the agent's JWKS endpoint.
type TrafficPolicySpec_AAuth struct {
	state              protoimpl.MessageState                 `protogen:"open.v1"`
	Mode               TrafficPolicySpec_AAuth_Mode           `protobuf:"varint,1,opt,name=mode,proto3,enum=agentgateway.dev.resource.TrafficPolicySpec_AAuth_Mode" json:"mode,omitempty"`
	RequiredScheme     TrafficPolicySpec_AAuth_RequiredScheme `protobuf:"varint,2,opt,name=required_scheme,json=requiredScheme,proto3,enum=agentgateway.dev.resource.TrafficPolicySpec_AAuth_RequiredScheme" json:"required_scheme,omitempty"`
	TimestampTolerance uint64                                 `protobuf:"varint,3,opt,name=timestamp_tolerance,json=timestampTolerance,proto3" json:"timestamp_tolerance,omitempty"`
	Challenge          *TrafficPolicySpec_AAuth_Challenge     `protobuf:"bytes,4,opt,name=challenge,proto3,oneof" json:"challenge,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *TrafficPolicySpec_AAuth) Reset() {
	*x = TrafficPolicySpec_AAuth{}
	mi := &file_resource_proto_msgTypes[76]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TrafficPolicySpec_AAuth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrafficPolicySpec_AAuth) ProtoMessage() {}

func (x *TrafficPolicySpec_AAuth) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[76]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrafficPolicySpec_AAuth.ProtoReflect.Descriptor instead.
func (*TrafficPolicySpec_AAuth) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{43, 8}
}

func (x *TrafficPolicySpec_AAuth) GetMode() TrafficPolicySpec_AAuth_Mode {
	if x != nil {
		return x.Mode
	}
	return TrafficPolicySpec_AAuth_STRICT
}

func (x *TrafficPolicySpec_AAuth) GetRequiredScheme() TrafficPolicySpec_AAuth_RequiredScheme {
	if x != nil {
		return x.RequiredScheme
	}
	return TrafficPolicySpec_AAuth_HWK
}

func (x *TrafficPolicySpec_AAuth) GetTimestampTolerance() uint64 {
	if x != nil {
...
func (x *TrafficPolicySpec_AAuth) GetChallenge() *TrafficPolicySpec_AAuth_Challenge {
	if x != nil {
		return x.Challenge
	}
	return nil
...
// Challenge configuration for 401 Agent-Auth responses
type TrafficPolicySpec_AAuth_Challenge struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *TrafficPolicySpec_AAuth_Challenge) Reset() {
	*x = TrafficPolicySpec_AAuth_Challenge{}
	mi := &file_resource_proto_msgTypes[93]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TrafficPolicySpec_AAuth_Challenge) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrafficPolicySpec_AAuth_Challenge) ProtoMessage() {}

func (x *TrafficPolicySpec_AAuth_Challenge) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[93]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrafficPolicySpec_AAuth_Challenge.ProtoReflect.Descriptor instead.
func (*TrafficPolicySpec_AAuth_Challenge) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{43, 8, 0}
}

func (x *TrafficPolicySpec_AAuth_Challenge) GetAuthServer() string {
	if x != nil {
		return x.AuthServer
	}
	return ""
...
func (*TrafficPolicySpec_TransformationPolicy_Transform) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{43, 9, 0}
}
...
func (*TrafficPolicySpec_ExtProc_NamespacedMetadataContext) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{43, 13, 2}
}
...
// AAuth backend verification — verifies incoming request signatures
// using the backend's service FQDN as canonical authority.
type BackendPolicySpec_AAuth struct {
	state              protoimpl.MessageState                 `protogen:"open.v1"`
	Mode               TrafficPolicySpec_AAuth_Mode           `protobuf:"varint,1,opt,name=mode,proto3,enum=agentgateway.dev.resource.TrafficPolicySpec_AAuth_Mode" json:"mode,omitempty"`
	RequiredScheme     TrafficPolicySpec_AAuth_RequiredScheme `protobuf:"varint,2,opt,name=required_scheme,json=requiredScheme,proto3,enum=agentgateway.dev.resource.TrafficPolicySpec_AAuth_RequiredScheme" json:"required_scheme,omitempty"`
...
func (x *BackendPolicySpec_AAuth) Reset() {
	*x = BackendPolicySpec_AAuth{}
	mi := &file_resource_proto_msgTypes[108]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BackendPolicySpec_AAuth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BackendPolicySpec_AAuth) ProtoMessage() {}

func (x *BackendPolicySpec_AAuth) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[108]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BackendPolicySpec_AAuth.ProtoReflect.Descriptor instead.
func (*BackendPolicySpec_AAuth) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{44, 8}
}

func (x *BackendPolicySpec_AAuth) GetMode() TrafficPolicySpec_AAuth_Mode {
	if x != nil {
		return x.Mode
	}
	return TrafficPolicySpec_AAuth_STRICT
...
func (x *BackendPolicySpec_AAuth) GetRequiredScheme() TrafficPolicySpec_AAuth_RequiredScheme {
	if x != nil {
		return x.RequiredScheme
	}
	return TrafficPolicySpec_AAuth_HWK
...
func (x *BackendPolicySpec_AAuth) GetTimestampTolerance() uint64 {
	if x != nil {
		return x.TimestampTolerance
	}
	return 0
...
func (x *BackendPolicySpec_AAuth) GetChallenge() *TrafficPolicySpec_AAuth_Challenge {
	if x != nil {
		return x.Challenge
	}
	return nil
...
const file_resource_proto_rawDesc = "" +
	...
	"\x05aauth\x18\x16 \x01(\v22.agentgateway.dev.resource.TrafficPolicySpec.AAuthH\x00R\x05aauth\x1a\xf0\x03\n" +
	...
	"\n" +
	"\x06STRICT\x10\x00\x12\f\n" +
	"\bOPTIONAL\x10\x01\x1a\xf5\x03\n" +
	"\x05AAuth\x12K\n" +
	"\x04mode\x18\x01 \x01(\x0e27.agentgateway.dev.resource.TrafficPolicySpec.AAuth.ModeR\x04mode\x12j\n" +
	"\x0frequired_scheme\x18\x02 \x01(\x0e2A.agentgateway.dev.resource.TrafficPolicySpec.AAuth.RequiredSchemeR\x0erequiredScheme\x12/\n" +
	"\x13timestamp_tolerance\x18\x03 \x01(\x04R\x12timestampTolerance\x12_\n" +
	"\tchallenge\x18\x04 \x01(\v2<.agentgateway.dev.resource.TrafficPolicySpec.AAuth.ChallengeH\x00R\tchallenge\x88\x01\x01\x1a,\n" +
	"\tChallenge\x12\x1f\n" +
	...
	"\n" +
	"PERMISSIVE\x10\x02\"3\n" +
	"\x0eRequiredScheme\x12\a\n" +
	"\x03HWK\x10\x00\x12\b\n" +
	"\x04JWKS\x10\x01\x12\x0e\n" +
	"\n" +
	"JWT_SCHEME\x10\x02B\f\n" +
	"\n" +
	"_challenge\x1a\x8b\x04\n" +
	...
	"backendTcp\x12J\n" +
	"\x05aauth\x18\x0e \x01(\v22.agentgateway.dev.resource.BackendPolicySpec.AAuthH\x00R\x05aauth\x1a\xd3 \n" +
	"\x02Ai\x12^\n" +
	...
	"\x06STRICT\x10\x01\x12\x0e\n" +
	"\n" +
	"PERMISSIVE\x10\x02\x1a\xe0\x02\n" +
	"\x05AAuth\x12K\n" +
	"\x04mode\x18\x01 \x01(\x0e27.agentgateway.dev.resource.TrafficPolicySpec.AAuth.ModeR\x04mode\x12j\n" +
	"\x0frequired_scheme\x18\x02 \x01(\x0e2A.agentgateway.dev.resource.TrafficPolicySpec.AAuth.RequiredSchemeR\x0erequiredScheme\x12/\n" +
	"\x13timestamp_tolerance\x18\x03 \x01(\x04R\x12timestampTolerance\x12_\n" +
	"\tchallenge\x18\x04 \x01(\v2<.agentgateway.dev.resource.TrafficPolicySpec.AAuth.ChallengeH\x00R\tchallenge\x88\x01\x01B\f\n" +
	"\n" +
	"_challengeB\x06\n" +
	"\x04kind\"7\n" +
...
var file_resource_proto_goTypes = []any{
	...
	(TrafficPolicySpec_AAuth_Mode)(0),                   // 13: agentgateway.dev.resource.TrafficPolicySpec.AAuth.Mode
	(TrafficPolicySpec_AAuth_RequiredScheme)(0),         // 14: agentgateway.dev.resource.TrafficPolicySpec.AAuth.RequiredScheme
	...
	(*TrafficPolicySpec_AAuth)(nil),                             // 104: agentgateway.dev.resource.TrafficPolicySpec.AAuth
	...
	(*TrafficPolicySpec_AAuth_Challenge)(nil),                // 121: agentgateway.dev.resource.TrafficPolicySpec.AAuth.Challenge
	...
	(*BackendPolicySpec_AAuth)(nil),                // 136: agentgateway.dev.resource.BackendPolicySpec.AAuth
	(*BackendPolicySpec_Ai_Message)(nil),           // 137: agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	(*BackendPolicySpec_Ai_PromptEnrichment)(nil),  // 138: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	(*BackendPolicySpec_Ai_RegexRule)(nil),         // 139: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	(*BackendPolicySpec_Ai_RegexRules)(nil),        // 140: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	(*BackendPolicySpec_Ai_Webhook)(nil),           // 141: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	(*BackendPolicySpec_Ai_Moderation)(nil),        // 142: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	(*BackendPolicySpec_Ai_BedrockGuardrails)(nil), // 143: agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	(*BackendPolicySpec_Ai_GoogleModelArmor)(nil),  // 144: agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	(*BackendPolicySpec_Ai_RequestRejection)(nil),  // 145: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	(*BackendPolicySpec_Ai_ResponseGuard)(nil),     // 146: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	(*BackendPolicySpec_Ai_RequestGuard)(nil),      // 147: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	(*BackendPolicySpec_Ai_PromptGuard)(nil),       // 148: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	(*BackendPolicySpec_Ai_PromptCaching)(nil),     // 149: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptCaching
	nil, // 150: agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	nil, // 151: agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
...
var file_resource_proto_depIdxs = []int32{
	...
	43,  // 37: agentgateway.dev.resource.BackendAuthPolicy.passthrough:type_name -> agentgateway.dev.resource.Passthrough
	44,  // 38: agentgateway.dev.resource.BackendAuthPolicy.key:type_name -> agentgateway.dev.resource.Key
	45,  // 39: agentgateway.dev.resource.BackendAuthPolicy.gcp:type_name -> agentgateway.dev.resource.Gcp
	46,  // 40: agentgateway.dev.resource.BackendAuthPolicy.aws:type_name -> agentgateway.dev.resource.Aws
	47,  // 41: agentgateway.dev.resource.BackendAuthPolicy.azure:type_name -> agentgateway.dev.resource.Azure
	...
	48,  // 44: agentgateway.dev.resource.Aws.explicit_config:type_name -> agentgateway.dev.resource.AwsExplicitConfig
	49,  // 45: agentgateway.dev.resource.Aws.implicit:type_name -> agentgateway.dev.resource.AwsImplicit
	50,  // 46: agentgateway.dev.resource.Azure.explicit_config:type_name -> agentgateway.dev.resource.AzureExplicitConfig
	54,  // 47: agentgateway.dev.resource.Azure.developer_implicit:type_name -> agentgateway.dev.resource.AzureDeveloperImplicit
	51,  // 48: agentgateway.dev.resource.AzureExplicitConfig.client_secret:type_name -> agentgateway.dev.resource.AzureClientSecret
	52,  // 49: agentgateway.dev.resource.AzureExplicitConfig.managed_identity_credential:type_name -> agentgateway.dev.resource.AzureManagedIdentityCredential
	53,  // 50: agentgateway.dev.resource.AzureExplicitConfig.workload_identity_credential:type_name -> agentgateway.dev.resource.AzureWorkloadIdentityCredential
	...
	56,  // 52: agentgateway.dev.resource.RouteMatch.path:type_name -> agentgateway.dev.resource.PathMatch
	59,  // 53: agentgateway.dev.resource.RouteMatch.headers:type_name -> agentgateway.dev.resource.HeaderMatch
	58,  // 54: agentgateway.dev.resource.RouteMatch.method:type_name -> agentgateway.dev.resource.MethodMatch
	57,  // 55: agentgateway.dev.resource.RouteMatch.query_params:type_name -> agentgateway.dev.resource.QueryMatch
	168, // 56: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	66,  // 57: agentgateway.dev.resource.HeaderModifier.add:type_name -> agentgateway.dev.resource.Header
	66,  // 58: agentgateway.dev.resource.HeaderModifier.set:type_name -> agentgateway.dev.resource.Header
	...
	40,  // 74: agentgateway.dev.resource.TrafficPolicySpec.timeout:type_name -> agentgateway.dev.resource.Timeout
	41,  // 75: agentgateway.dev.resource.TrafficPolicySpec.retry:type_name -> agentgateway.dev.resource.Retry
	...
	105, // 80: agentgateway.dev.resource.TrafficPolicySpec.transformation:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	...
	108, // 82: agentgateway.dev.resource.TrafficPolicySpec.csrf:type_name -> agentgateway.dev.resource.TrafficPolicySpec.CSRF
	109, // 83: agentgateway.dev.resource.TrafficPolicySpec.ext_proc:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc
	62,  // 84: agentgateway.dev.resource.TrafficPolicySpec.request_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	62,  // 85: agentgateway.dev.resource.TrafficPolicySpec.response_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	64,  // 86: agentgateway.dev.resource.TrafficPolicySpec.request_redirect:type_name -> agentgateway.dev.resource.RequestRedirect
	65,  // 87: agentgateway.dev.resource.TrafficPolicySpec.url_rewrite:type_name -> agentgateway.dev.resource.UrlRewrite
	63,  // 88: agentgateway.dev.resource.TrafficPolicySpec.request_mirror:type_name -> agentgateway.dev.resource.RequestMirrors
	61,  // 89: agentgateway.dev.resource.TrafficPolicySpec.direct_response:type_name -> agentgateway.dev.resource.DirectResponse
	60,  // 90: agentgateway.dev.resource.TrafficPolicySpec.cors:type_name -> agentgateway.dev.resource.CORS
	...
	104, // 94: agentgateway.dev.resource.TrafficPolicySpec.aauth:type_name -> agentgateway.dev.resource.TrafficPolicySpec.AAuth
	...
	136, // 108: agentgateway.dev.resource.BackendPolicySpec.aauth:type_name -> agentgateway.dev.resource.BackendPolicySpec.AAuth
	...
	13,  // 147: agentgateway.dev.resource.TrafficPolicySpec.AAuth.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.AAuth.Mode
	14,  // 148: agentgateway.dev.resource.TrafficPolicySpec.AAuth.required_scheme:type_name -> agentgateway.dev.resource.TrafficPolicySpec.AAuth.RequiredScheme
	121, // 149: agentgateway.dev.resource.TrafficPolicySpec.AAuth.challenge:type_name -> agentgateway.dev.resource.TrafficPolicySpec.AAuth.Challenge
	122, // 150: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.request:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	122, // 151: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.response:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	78,  // 152: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.target:type_name -> agentgateway.dev.resource.BackendReference
	...
	123, // 154: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.request_attributes:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.RequestAttributesEntry
	124, // 155: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.response_attributes:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ResponseAttributesEntry
	126, // 156: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.metadata_context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.MetadataContextEntry
	...
	169, // 164: agentgateway.dev.resource.TrafficPolicySpec.APIKey.User.metadata:type_name -> google.protobuf.Struct
	106, // 165: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.set:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	106, // 166: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.add:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	107, // 167: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.body:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BodyTransformation
	127, // 168: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.ContextEntry
	125, // 169: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.MetadataContextEntry.value:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext
	148, // 170: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_guard:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	150, // 171: agentgateway.dev.resource.BackendPolicySpec.Ai.defaults:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	151, // 172: agentgateway.dev.resource.BackendPolicySpec.Ai.overrides:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
	138, // 173: agentgateway.dev.resource.BackendPolicySpec.Ai.prompts:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	...
	149, // 175: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_caching:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptCaching
	...
	78,  // 177: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.endpoint_picker:type_name -> agentgateway.dev.resource.BackendReference
	...
	13,  // 188: agentgateway.dev.resource.BackendPolicySpec.AAuth.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.AAuth.Mode
	14,  // 189: agentgateway.dev.resource.BackendPolicySpec.AAuth.required_scheme:type_name -> agentgateway.dev.resource.TrafficPolicySpec.AAuth.RequiredScheme
	121, // 190: agentgateway.dev.resource.BackendPolicySpec.AAuth.challenge:type_name -> agentgateway.dev.resource.TrafficPolicySpec.AAuth.Challenge
	137, // 191: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	137, // 192: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	...
	139, // 195: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	...
	145, // 201: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	140, // 202: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	141, // 203: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	144, // 204: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.google_model_armor:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	143, // 205: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.bedrock_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	145, // 206: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	140, // 207: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	141, // 208: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	142, // 209: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	144, // 210: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.google_model_armor:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	143, // 211: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.bedrock_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	147, // 212: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	146, // 213: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
